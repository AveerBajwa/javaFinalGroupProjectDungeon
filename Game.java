...
public class Game extends Canvas {
	...
	private long lastBomb = 0; // time last bomb fired
	private long firingInterval = 200; // interval between shots (ms)
	private long bombInterval = 3000;
	...
	public Game() {
		...
		JFrame container = new JFrame("Space Evaders");
	...
	private void initEntities() {
		...
		ship = new ShipEntity(this, "sprites/ship.gif", 50, 950);
		entities.add(ship);
		...
		for (int row = 0; row < 7; row++) {
			for (int col = 0; col < 12; col++) {
				Entity alien = new AlienEntity(this, "sprites/alien.gif", 100 + (col * 40), 50 + (row * 30));
				entities.add(alien);
				alienCount++;
			} // for
		} // outer for
	...
	public void tryToBomb() {
		...
		BombEntity bomb = new BombEntity(this, "sprites/bomb.gif", ship.getX() + 10, ship.getY() - 30);
		entities.add(bomb);
	} // tryToBomb
